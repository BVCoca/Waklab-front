    ...
    <div className="detailsContent">
        <div className="headerDetails">
            ...
            <div className="blockCenter">
                <h1>{dungeon.name}</h1>
                <div className="dungeonMaxPlayer"><p className="dungeonMaxPlayerText">Nombre de joueurs max: </p><Image className="dungeonMaxPlayerImage" src={IconPlayer} width={22} height={35} alt=""/><p>x</p><p className="dungeonMaxPlayerNumber">{dungeon.max_player}</p></div> 
                <div className="dungeonRoomCount"><p className="dungeonRoomCountText">Nombre de salles:  </p><p className="dungeonRoomCountNumber">{dungeon.room_count}</p><Image className="dungeonRoomCountImage" src={IconRoom} width={20} height={30} alt=""/></div>
            </div>
